...
_$$ResultDataCopyWith<T, _$ResultData<T>> get copyWith => __$$ResultDataCopyWithImpl<T, _$ResultData<T>>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$ResultData<T>&&const DeepCollectionEquality().equals(other.value, value));
}
...
abstract mixin class _$$ResultDataCopyWith<T,$Res> implements $ResultCopyWith<T, $Res> {
  factory _$$ResultDataCopyWith(_$ResultData<T> value, $Res Function(_$ResultData<T>) _then) = __$$ResultDataCopyWithImpl;
@useResult
$Res call({
 T value
});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$$ResultErrorCopyWith<T, _$ResultError<T>> get copyWith => __$$ResultErrorCopyWithImpl<T, _$ResultError<T>>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$ResultError<T>&&const DeepCollectionEquality().equals(other.error, error)&&(identical(other.stackTrace, stackTrace) || other.stackTrace == stackTrace));
}
...
abstract mixin class _$$ResultErrorCopyWith<T,$Res> implements $ResultCopyWith<T, $Res> {
  factory _$$ResultErrorCopyWith(_$ResultError<T> value, $Res Function(_$ResultError<T>) _then) = __$$ResultErrorCopyWithImpl;
@useResult
$Res call({
